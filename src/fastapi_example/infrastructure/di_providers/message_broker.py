...
from fastapi_example.infrastructure.message_broker.producers import EmailNotificationsProducer
...
class MessageBrokerProducersProvider(Provider):
    @provide(scope=Scope.APP)
    def email_notifications_producer(self, broker: KafkaBroker) -> IEmailNotificationsProducer:
