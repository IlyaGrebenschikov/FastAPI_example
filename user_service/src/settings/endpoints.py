...
from user_service.src.api.v1.endpoints.test import test_router
from user_service.src.api.v1.endpoints.user import user_router
from user_service.src.api.v1.endpoints.auth import auth_router
